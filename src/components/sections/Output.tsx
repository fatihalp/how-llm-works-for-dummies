    ...
    <motion.div variants={container} initial="hidden" animate="show" className="space-y-8">
      ...
      <motion.div variants={item} className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
        ...
        <div className="flex flex-col items-center gap-3">
          {[t("out.loop.1"), t("out.loop.2"), t("out.loop.3"), t("out.loop.4"), t("out.loop.5")].map((step, i) => (
            <motion.div
              key={step}
            ...
            >
              <span className="w-6 h-6 rounded-full bg-purple-600/40 border border-purple-500/50 flex items-center justify-center text-xs text-purple-300">
                {i + 1}
              </span>
